...
/datum/spawnpanel/ui_status(mob/user, datum/ui_state/state)
	return check_rights_for(user.client, R_SPAWN) ? UI_INTERACTIVE : UI_CLOSE
...
/datum/spawnpanel/InterceptClickOn(mob/user, params, atom/target)
