...
GLOBAL_LIST_INIT(metal_recipes, list ( \
	...
	new /datum/stack_recipe_list("airlock assemblies", list( \
		...
		new /datum/stack_recipe("hydroponics airlock assembly", /obj/structure/door_assembly/door_assembly_hydro, 4, crafting_flags = CRAFT_CHECK_DENSITY | CRAFT_ONE_PER_TURF | CRAFT_ON_SOLID_GROUND, time = 5 SECONDS, category = CAT_DOORS), \
